...
@Autonomous(name="Blue Basket V1", group="Linear Opmode")      // This is the Displat Name on the Driver Hub 

public class BlueBasketV1 extends LinearOpMode {              // Make sure to rename the file to match the file name.
...
private ElapsedTime     runtime = new ElapsedTime();
    ...
    public void runOpMode() {
        ...
        */        
        ...
        driveDiagonal(0.16, -0.4);
        runArmToPos(armMode.HIGH);
        drivetrainAuto.profiledTurnHeading(-45.0);
        runOuttake(1000);
        drivetrainAuto.profiledTurnHeading(90.0);
        driveDiagonal(-0.2, 0.65);
        drivetrainAuto.profiledDriveStraight(-0.5);
        runArmToPos(armMode.INTAKE);
        runIntakeMovement(0.7, 2500, intakeMode.INTAKING);
        runArmToPos(armMode.HIGH);
        drivetrainAuto.profiledTurnHeading(-90.0);
        driveDiagonal(-0.65, 0.0);
        runOuttake(1000);
        runArmToPos(armMode.HOME);
        sleep(1000);
