...
@Autonomous(name="Autonomous Template", group="Linear Opmode")      // This is the Displat Name on the Driver Hub 

public class AutonomousTemplate extends LinearOpMode {              // Make sure to rename the file to match the file name.
...
private ElapsedTime     runtime = new ElapsedTime();
    ...
    private CRServo specLServo, specRServo, climberLServo, climberRServo;
    ...
    public void runSpec(specMode mode, double drivelenght) {
        if (mode == specMode.HOME) {
            ...
            drivetrainAuto.profiledDriveStraight(-drivelenght);
            drivetrainAuto.profiledTurnHeading(90.0);
        } 
    ...
    public void runOpMode() {
        ...
        // Climber Servos
        climberLServo = hardwareMap.get(CRServo.class, "climberL");
        climberRServo = hardwareMap.get(CRServo.class, "climberR");
        ...
        */
        ...
        // Start Climber
        climberLServo.setPower(0.6);
        climberRServo.setPower(0.6);        

        // You don't Need Start/Stop Climber, But if you do, Write your auton code here & replace this line :) 
        
        // Stop Climber
        climberLServo.setPower(0.0);
        climberRServo.setPower(0.0);
