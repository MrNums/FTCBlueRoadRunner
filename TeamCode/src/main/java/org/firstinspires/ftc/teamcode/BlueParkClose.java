...
/*
 * The robot will start at the edge of the observation zone and park immediately into the right corner of the observation zone. 
 */

@Autonomous(name="Blue Park Far", group="Linear Opmode")

public class BlueParkClose extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        */
        ...
        drivetrainAuto.profiledDriveSideways(0.25);
